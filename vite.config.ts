...
export default defineConfig(({ mode }) => {
  // 🔧 Carregar .env corretamente (inclui variáveis VITE_*)
  ...
  console.log('🔧 process.env.VITE_API_URL:', env.VITE_API_URL);
  console.log('🔧 process.env.VITE_API_BASE_URL:', env.VITE_API_BASE_URL);
  console.log('🔧 process.env keys:', Object.keys(env).filter(key => key.includes('VITE')));
  console.log('='.repeat(50));
